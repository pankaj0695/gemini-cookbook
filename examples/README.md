...
| -------- | ----------- | -------- | ---- |
| [Cost and latency optimization](./Cost_and_Latency_Optimization.ipynb) | Practical patterns to reduce cost and latency: token counting, streaming, prompt trimming, model selection and Batch API. | Streaming, Batch API, Tokens | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/google-gemini/cookbook/blob/main/examples/Cost_and_Latency_Optimization.ipynb) |
